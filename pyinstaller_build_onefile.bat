...
echo [3/4] 开始打包（单文件版 onefile）...
pyinstaller --noconfirm --clean --onefile ^
  --name investment_lead_system_web ^
  --distpath "..\\release\\pyinstaller\\dist_onefile" ^
  --workpath "..\\release\\pyinstaller\\build_onefile" ^
...
echo [4/4] 打包完成。exe：..\\release\\pyinstaller\\dist_onefile\\investment_lead_system_web.exe
pause
